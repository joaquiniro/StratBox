...
public class OfflineAi3x3 extends AppCompatActivity implements View.OnClickListener {
    ...
    String checkbox[][] =new String[7][7];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_offline_ai3x3);
    ...
    public void onClick(View v) {
        ...
        Log.d("ComputerMove", "myMove: "+ myMove );
        checkForBox();
        RotatePlayer();
        ComputerMoveTime();
        time = 30000;
...
//                Log.d("noneSkip", skip);
            ...
            skip = "false";
            Log.d("ComputerMove", "Computer: "+ ComputerMove);
    ...
    public void checkWinner(){
        Log.d("score", "P1: " +p1point + "P2: "+ p2point);
        if(p1>=5){
            winner =1;
        }
        else if(p2>=5){
    ...
    public void popupWindow(){
        String gameMode ="PVC";
        Intent intent = new Intent(OfflineAi3x3.this, popUpActivityOffline.class);
