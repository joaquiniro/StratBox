...
public class OfflineAi4x4 extends AppCompatActivity implements View.OnClickListener {
    Random r = new Random();
    int player = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_offline_ai4x4);
...
//                }
    ...
    public void popupWindow(){
        String gameMode ="PVC";
        Intent intent = new Intent(OfflineAi4x4.this, popUpActivityOffline.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(OfflineAi4x4.this, Game.class);
        mediaPlayer.release();
        mediaPlayer = null;
        startActivity(intent);
        finish();
