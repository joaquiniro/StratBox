...
public class OfflinePVP3x3 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_offline_pvp3x3);
    ...
    public void popupWindow(){
        Intent intent = new Intent(OfflinePVP3x3.this, popUpActivityOffline.class);
